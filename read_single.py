...
contourIdir='final_data/contourfiles/SC-HF-I-1/i-contours/IM-0001-0048-icontour-manual.txt'
...
dh, dw=dp1.shape
c1=parse_contour_file(contourOdir)
...
plt.axis('off')
plt.subplot(1,2,2)
plt.imshow(dp1+m1*300,cmap=plt.gray(),vmin=0, vmax=300)
plt.axis('off')
plt.show()
